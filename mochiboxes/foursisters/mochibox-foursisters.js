...
// let js = document.createElement("script"); js.src = "http://localhost:8080/mochiboxes/foursisters/mochibox-foursisters.js"; document.body.appendChild(js);
...
popupText.innerHTML = 'Half-off lunch<br><hr style="color:white; margin: 5px">Enter your email';
popupText.style = `
  color: white;
...
restaurantLogo.src = 'http://localhost:8080/mochiboxes/foursisters/logo.png';
...
popupImg.src = 'http://localhost:8080/mochiboxes/foursisters/food.jpg';
popupImg.style = `
  z-index: 10;
  pointer-events: none;
